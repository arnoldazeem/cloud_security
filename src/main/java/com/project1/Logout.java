	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{      
			...
			if (session.getAttribute("realm") == "GOOGLE") {
				...
				response.sendRedirect("https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=http://localhost:8080/project1/");
				...
				response.sendRedirect("https://www.facebook.com/logout.php?next=http://localhost:8080/project1/&access_token="+access.toString());
				//response.sendRedirect("http://m.facebook.com/logout.php?confirm=1&next=http://localhost:8080/project1");
