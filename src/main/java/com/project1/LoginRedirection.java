	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(realm.equalsIgnoreCase("Facebook"))
		{
			...
			try {
				...
				URI authURI = new URI("https://www.facebook.com/dialog/oauth?client_id=291742937887420&redirect_uri=http://localhost:8080/project1/ReturnFacebook&scope=email&scope=profile&scope=user_friends");
